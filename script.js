document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatedElements = document.querySelectorAll(
    '.fade-in, .scroll-animate, [data-animate], .feature-card, .pricing-card, .testimonial-card, .section-header, .hero-content'
  );
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3f80b74a-181e-48f9-b37d-7d8735e72a82',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3f80b74a-181e-48f9-b37d-7d8735e72a82';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3f80b74a-181e-48f9-b37d-7d8735e72a82';
